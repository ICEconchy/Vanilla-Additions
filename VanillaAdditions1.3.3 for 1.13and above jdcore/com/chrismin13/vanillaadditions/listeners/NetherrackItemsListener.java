  ...
  public void onRightClickBlock(PlayerInteractEvent paramPlayerInteractEvent)
  {
    ...
    if ((localBlockFace == BlockFace.UP) || (localBlockFace == BlockFace.EAST) || (localBlockFace == BlockFace.NORTH) || (localBlockFace == BlockFace.SOUTH) || (localBlockFace == BlockFace.WEST))
    {
      if (((localCustomItem instanceof NetherrackShovel)) && (localMaterial == Material.GRASS))
        return;
      if (((localCustomItem instanceof com.chrismin13.vanillaadditions.items.netherrack.NetherrackHoe)) && ((localMaterial == Material.GRASS) || (localMaterial == Material.GRASS_PATH) || (localMaterial == Material.PODZOL)))
      {
    ...
    BlockIgniteEvent localBlockIgniteEvent = new BlockIgniteEvent(localBlock1, org.bukkit.event.block.BlockIgniteEvent.IgniteCause.FLINT_AND_STEEL, localPlayer, localBlock2);
