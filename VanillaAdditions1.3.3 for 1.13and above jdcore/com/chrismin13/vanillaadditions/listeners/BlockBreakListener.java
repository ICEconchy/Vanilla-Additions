...
public class BlockBreakListener implements Listener
{
  ...
  public void onCustomItemBlockBreak(CustomItemBlockBreakEvent paramCustomItemBlockBreakEvent) {
    ...
    if (BlockUtils.isBlockIgnored(localBlock))
      return;
    if ((((localCustomItem instanceof DoubleAxeAbilities)) && ((localMaterial.equals(Material.ACACIA_LOG)) || 
      (localMaterial.equals(Material.BIRCH_LOG)) || (localMaterial.equals(Material.DARK_OAK_LOG)) || 
      (localMaterial.equals(Material.JUNGLE_LOG)) || (localMaterial.equals(Material.SPRUCE_LOG)))) || 
      (localMaterial.equals(Material.OAK_LOG))) {
