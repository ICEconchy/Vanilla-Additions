...
public class EmeraldSickle
  extends EmeraldItem implements SickleAbilities
{
  public EmeraldSickle()
  {
    super(DamageableItem.DIAMOND_HOE, "vanilla_additions:emerald_sickle", "Emerald Sickle", "emerald_sickle");
