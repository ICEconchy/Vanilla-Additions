...
{
  public WoodBasedItem(DamageableItem paramDamageableItem, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    super(paramDamageableItem, 59, "vanilla_additions:" + paramString1 + "_" + paramString4, paramString3, paramString2);
  }
  
  public WoodBasedItem(DamageableItem paramDamageableItem, Material paramMaterial, String paramString1, String paramString2, String paramString3)
  {
    ...
    addAllCustomRecipes(getToolType().getCustomShapedRecipe(new RecipeIngredient(paramMaterial), new RecipeIngredient(Material.STICK)));
  }
}
