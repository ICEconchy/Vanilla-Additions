...
public class EmeraldDoubleAxe
  extends EmeraldItem implements DoubleAxeAbilities
{
  public EmeraldDoubleAxe()
  {
    super(DamageableItem.DIAMOND_AXE, "vanilla_additions:emerald_double_axe", "Emerald Double Axe", "emerald_double_axe");
