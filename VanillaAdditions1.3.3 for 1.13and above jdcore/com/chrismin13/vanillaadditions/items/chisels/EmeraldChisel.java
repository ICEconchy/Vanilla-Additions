...
public class EmeraldChisel
  extends EmeraldItem implements ChiselAbilities
{
  public EmeraldChisel()
  {
    super(DamageableItem.DIAMOND_PICKAXE, "vanilla_additions:emerald_chisel", "Emerald Chisel", "emerald_chisel");
