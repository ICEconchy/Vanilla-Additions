...
public class RedstoneChisel
  extends RedstoneItem implements ChiselAbilities
{
  public RedstoneChisel()
  {
    super(DamageableItem.STONE_PICKAXE, "vanilla_additions:redstone_chisel", "Redstone Chisel", "redstone_chisel");
