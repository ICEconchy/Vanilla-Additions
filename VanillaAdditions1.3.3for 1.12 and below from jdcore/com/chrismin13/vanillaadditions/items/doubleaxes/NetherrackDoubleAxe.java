...
public class NetherrackDoubleAxe
  extends NetherrackItem implements DoubleAxeAbilities
{
  public NetherrackDoubleAxe()
  {
    super(DamageableItem.STONE_AXE, "vanilla_additions:netherrack_double_axe", "Netherrack Double Axe", "netherrack_double_axe");
